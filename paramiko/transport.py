...
from cryptography.hazmat.primitives.ciphers.algorithms import AES, TripleDES, ARC4, Blowfish
...
class Transport (threading.Thread):
    ...
    def _activate_inbound(self):
        ...
        engine = self._get_cipher(self.remote_cipher, key_in, IV_in, encrypt=False)
    ...
    def _activate_outbound(self):
        ...
        engine = self._get_cipher(self.local_cipher, key_out, IV_out, encrypt=True)
